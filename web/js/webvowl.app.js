...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {module.exports = function () {
		...
		// Modules for the webvowl app
			...
			resetMenu,
			pauseMenu,
			sidebar = __webpack_require__(70)(graph),
			setupableMenues,
		// Graph modules
		...
		app.initialize = function () {
			...
			exportMenu = __webpack_require__(71)(options.graphContainerSelector());
			gravityMenu = __webpack_require__(72)(graph);
			filterMenu = __webpack_require__(73)(graph, datatypeFilter, subclassFilter, disjointFilter, setOperatorFilter, nodeDegreeFilter);
			modeMenu = __webpack_require__(74)(graph, pickAndPin, nodeScalingSwitch, compactNotationSwitch);
			pauseMenu = __webpack_require__(75)(graph);
			resetMenu = __webpack_require__(76)(graph, [gravityMenu, filterMenu, modeMenu,
				focuser, selectionDetailDisplayer, pauseMenu]);
			ontologyMenu = __webpack_require__(77)(loadOntologyFromText);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (graph) {
		...
		gravityMenu.setup = function () {
			addDistanceSlider("#classSliderOption", "class", "Khoảng cách đối tượng", options.classDistance);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (loadOntologyFromText) {
		...
		var ontologyMenu = {},
			defaultJsonName = "bieudo", // This file is loaded by default
		...
		function parseUrlAndLoadOntology() {
			...
			if (hashParameter.substr(0, fileKey.length) === fileKey) {
				...
				loadOntologyFromUri(__webpack_require__(78)("./" + hashParameter + ".json"), hashParameter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		//"./benchmark.json": 79,
		//"./foaf.json": 80,
		//"./goodrelations.json": 81,
		//"./muto.json": 82,
		//"./ontovibe.json": 83,
		//"./personasonto.json": 84,
		//"./sioc.json": 85,
                "./bieudo.json": 86
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/benchmark.json?d5d07972ddf0459c397916c8001e761c"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/foaf.json?c42b65921e9390d684730607e060b3d6"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/goodrelations.json?f0cab2e1d6df87859caf716c78c16942"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/muto.json?eaabaf251b184714f8894573a4d028ba"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/ontovibe.json?568253d576cc982dc7880565580c11c2"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/personasonto.json?304ff6fcbf3a12ef8adb85825d980849"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "data/sioc.json?4ffe419f2608709084060f6e35c29558"

/***/ },
/***/ 86:
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "/data/bieudo.json?4ffae419f2608709084060f6e35c29558"
