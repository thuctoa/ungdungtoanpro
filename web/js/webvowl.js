...
/***/ function(module, exports, __webpack_require__) {
	...
	var labelMap = __webpack_require__(31)();
	
	
	var webvowl = {};
	webvowl.graph = __webpack_require__(45);
	webvowl.options = __webpack_require__(51);
	webvowl.version = "0.4.0";
	
	webvowl.util = {};
	webvowl.util.constants = __webpack_require__(12);
	webvowl.util.languageTools = __webpack_require__(11);
	webvowl.util.elementTools = __webpack_require__(50);
	
	webvowl.modules = {};
	webvowl.modules.compactNotationSwitch = __webpack_require__(54);
	webvowl.modules.datatypeFilter = __webpack_require__(55);
	webvowl.modules.disjointFilter = __webpack_require__(57);
	webvowl.modules.focuser = __webpack_require__(58);
	webvowl.modules.nodeDegreeFilter = __webpack_require__(59);
	webvowl.modules.nodeScalingSwitch = __webpack_require__(60);
	webvowl.modules.pickAndPin = __webpack_require__(61);
	webvowl.modules.selectionDetailsDisplayer = __webpack_require__(62);
	webvowl.modules.setOperatorFilter = __webpack_require__(63);
	webvowl.modules.statistics = __webpack_require__(64);
	webvowl.modules.subclassFilter = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var drawTools = __webpack_require__(13)();
	...
	module.exports = (function () {
		...
		var o = function (graph) {
			...
			this.postDrawActions = function () {
				var textBlock = __webpack_require__(14)(that.nodeElement());
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var textTools = __webpack_require__(15)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetOperatorNode = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OwlThing = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatatypeNode = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RectangularNode = __webpack_require__(28);
	...
	module.exports = (function () {
		...
		var o = function (graph) {
			...
			this.drawNode = function (parentElement, additionalCssClasses) {
				...
				textBlock = __webpack_require__(14)(parentElement);
				textBlock.addText(that.labelForCurrentLanguage());
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var labels = [];
	labels.push(__webpack_require__(32));
	labels.push(__webpack_require__(35));
	labels.push(__webpack_require__(34));
	labels.push(__webpack_require__(36));
	labels.push(__webpack_require__(37));
	labels.push(__webpack_require__(38));
	labels.push(__webpack_require__(39));
	labels.push(__webpack_require__(40));
	labels.push(__webpack_require__(41));
	labels.push(__webpack_require__(42));
	labels.push(__webpack_require__(43));
	labels.push(__webpack_require__(44));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseLabel = __webpack_require__(33);
		...
		var base = function (graph) {
			...
			this.drawProperty = function (labelGroup) {
				function attachLabel(property) {
					...
					var textBox = __webpack_require__(14)(label);
					if (property instanceof __webpack_require__(34)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var math = __webpack_require__(46)();
	var linkCreator = __webpack_require__(47)();
	var elementTools = __webpack_require__(50)();
	...
	module.exports = function (graphContainerSelector) {
		var graph = {},
			...
			options = __webpack_require__(51)(),
			parser = __webpack_require__(52)(graph),
			language = "default",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
		...
		function groupPropertiesToLinks(properties) {
			var links = [],
				property,
				addedProperties = __webpack_require__(48)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseNode = __webpack_require__(9);
	var DatatypeNode = __webpack_require__(27);
	var ObjectProperty = __webpack_require__(39);
	var DatatypeProperty = __webpack_require__(32);
	var RdfsSubClassOf = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var OwlThing = __webpack_require__(23);
	var RdfsLiteral = __webpack_require__(29);
	var OwlDisjointWith = __webpack_require__(34);
	var attributeParser = __webpack_require__(53)();
	var elementTools = __webpack_require__(50)();
	var nodeMap = __webpack_require__(5)();
	var labelMap = __webpack_require__(31)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var elementTools = __webpack_require__(50)();
	var filterTools = __webpack_require__(56)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
		...
		tools.filterNodesAndTidy = function (nodes, properties, shouldKeepNode) {
			var removedNodes = __webpack_require__(48)(),
				cleanedNodes = [],
				cleanedProperties = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		var filter = {},
			...
			filteredNodes,
			filteredProperties,
			filterTools = __webpack_require__(56)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var SetOperatorNode = __webpack_require__(18);
	var OwlThing = __webpack_require__(23);
	var OwlNothing = __webpack_require__(22);
	var elementTools = __webpack_require__(50)();
	...
	module.exports = function () {
		...
		function storeTotalCounts(classesAndDatatypes, properties) {
			...
			var seenProperties = __webpack_require__(48)(), i, l, property;
			for (i = 0, l = properties.length; i < l; i++) {
				property = properties[i];
		...
		function findRelevantConnectedProperties(node, allProperties, visitedNodes) {
			...
			for (i = 0, l = allProperties.length; i < l; i++) {
				...
				if (property.domain() === node ||
					...
					if (elementTools.isRdfsSubClassOf(property)) {
						var domain = property.domain();
						visitedNodes = visitedNodes || __webpack_require__(48)();
